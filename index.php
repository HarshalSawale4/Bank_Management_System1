...
?>
    ...
    #img{
        ...
        <nav class="navbar navbar-lg navbar-expand-lg navbar-transparant navbar-dark navbar-absolute w-100">
            <div class="container">
                <div class="img">
                    <img id="image" src="./logo34208231299.webp" height="100px" width="110px" alt="logo">
                </div>
                <br>
                <br>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a class="btn btn-danger" href="client/pages_client_signup.php" target="_blank">Register</a>
                </div>
            </div>
        </nav>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12 col-sm-10 col-md-8 col-lg-6 mx-auto text-center">
                            ...
                            <br>
                            <a class="btn btn-success btn-lg mr-lg-2 my-1" target="_blank" href="client/pages_client_signup.php" role="button">Register</a>
                        </div>
                    </div>
                </div>
            </div>
